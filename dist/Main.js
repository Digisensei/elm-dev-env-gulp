...
var _user$project$App$decodeGifUrl = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'data',
...
var _user$project$App$NewGif = function (a) {
...
var _user$project$App$getRandomGif = function (topic) {
	...
	return A2(
		...
		_user$project$App$NewGif,
		A2(_elm_lang$http$Http$get, url, _user$project$App$decodeGifUrl));
};
var _user$project$App$init = function (topic) {
	return {
		ctor: '_Tuple2',
		_0: A2(_user$project$App$Model, topic, 'waiting.gif'),
		_1: _user$project$App$getRandomGif(topic)
	};
};
	...
	function (msg, model) {
		...
		if (_p0.ctor === 'MorePlease') {
			return {
				ctor: '_Tuple2',
				_0: model,
				_1: _user$project$App$getRandomGif(model.topic)
			};
		} else {
			if (_p0._0.ctor === 'Ok') {
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$App$Model, model.topic, _p0._0._0),
...
var _user$project$App$MorePlease = {ctor: 'MorePlease'};
var _user$project$App$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('cont'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$src('assets/icon.png'),
							_1: {
								ctor: '::',
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html$text('Digisensei'),
						_1: {ctor: '[]'}
					}
				}),
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_user$project$App$MorePlease),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _user$project$Main$main = _elm_lang$html$Html$program(
	{
		init: _user$project$App$init('ninjas'),
